...
=== ":fontawesome-brands-java: Java"
    ...
    | Framework   | Default Port | Docs |
    | ----------- | ------------ | ---- |
    | Spring Boot | 8080         | [:material-open-in-new:](https://spring.io/projects/spring-boot){ target="_blank" } |
    | Quarkus     | 8080         | [:material-open-in-new:](https://quarkus.io){ target="_blank" } |
    | Micronaut   | 8080         | [:material-open-in-new:](https://micronaut.io){ target="_blank" } |
    | Vert.x      | 8888         | [:material-open-in-new:](https://vertx.io){ target="_blank" } |

=== ":simple-dotnet: C#"

    | Framework    | Default Port | Docs |
    | ------------ | ------------ | ---- |
    | ASP.NET Core | 5000         | [:material-open-in-new:](https://learn.microsoft.com/en-us/aspnet/core){ target="_blank" } |
    | Minimal API  | 5000         | [:material-open-in-new:](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/minimal-apis){ target="_blank" } |
...
=== ":simple-ruby: Ruby"
    ...
    | Framework    | Default Port | Docs |
    | ------------ | ------------ | ---- |
    | Rails (Puma) | 3000         | [:material-open-in-new:](https://rubyonrails.org){ target="_blank" } |
    | Sinatra      | 4567         | [:material-open-in-new:](https://sinatrarb.com){ target="_blank" } |

=== ":simple-elixir: Elixir"

    | Framework | Default Port | Docs |
    | --------- | ------------ | ---- |
    | Phoenix   | 4000         | [:material-open-in-new:](https://www.phoenixframework.org){ target="_blank" } |
