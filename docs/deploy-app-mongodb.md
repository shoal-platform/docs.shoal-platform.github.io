...
Open the mongodb node and click setup. If Mongo credentials are not saved for the space yet, Shoal prompts you with a modal to enter your Atlas Client ID and Client Secret before continuing. After credentials are saved, continue through the MongoDB configuration fields.
...
Map the MongoDB output to your container environment variable, usually `MONGODB_URI`.
