...
In the setup dialog, choose your **Organization**, then either select an existing **Project** and **Cluster** or choose **Create on deployment** where needed. If you're creating a new cluster, choose a **tier** before clicking **Done**.
